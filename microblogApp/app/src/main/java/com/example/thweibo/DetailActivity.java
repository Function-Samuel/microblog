...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDetailLike = (TextView) findViewById(R.id.like_cnt); // 点赞数
        ...
        mDetailLike.setText(mBlog.getmLike());
        ...
        // 转发
        mRetweet = (ImageView) findViewById(R.id.retweet);
...
//                            retweet();
                            mBlog = getIntent().getParcelableExtra("blog");
                            String urlStr = ServerConfigure.getRetweet();
                            String params ="weibo_id=" + mBlog.getWeiboId() + "&new_username=" + getUsername();
                            String requestMethod = "POST";
                            MyHttpRequest myhttprequest = new MyHttpRequest();
                            myhttprequest.sendHttpRequest(urlStr, params, requestMethod);
                            Looper.prepare();
        ...
        // 点赞
        mThumb = (ImageView) findViewById(R.id.like);
            ...
            public void onClick(View view) {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            mBlog = getIntent().getParcelableExtra("blog");
                            String urlStr = ServerConfigure.getLike();
                            String params ="weibo_id=" + mBlog.getWeiboId() + "&username=" + getUsername();
                            String requestMethod = "POST";
                            MyHttpRequest myhttprequest = new MyHttpRequest();
                            myhttprequest.sendHttpRequest(urlStr, params, requestMethod);
                            Looper.prepare();
        ...
        class mClick implements OnClickListener {
            ...
            public void onClick(View v) {
                mBlog = getIntent().getParcelableExtra("blog");
                String uri = "http://192.168.0.196/microblog/video/" + mBlog.getmVideoPath() + ".mp4";
    ...
    private List<Comment> fetchComments() {
        ...
        String params = "weibo_id=" + mBlog.getWeiboId();
        String requestMethod = "POST";
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                comment.setBlogId(commentObject.getInt("weibo_id"));
