...
public class ServerConfigure {
    private static String mIp = "192.168.0.196:80";
    ...
    public static String getRetweet() {
        return "http://" + getIP() + "/microblog/retweet.php";
    }

    public static String getLike() { return "http://" + getIP() + "/microblog/like.php"; }

    public static String getFetchLikes() { return "http://" + getIP() + "/microblog/fetchlikes.php"; }

    public static String getUploadVideo() {
        return "http://" + getIP() + "/microblog/uploadvideo.php";
    }
}